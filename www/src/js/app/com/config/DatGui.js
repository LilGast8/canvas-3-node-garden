...
APP.DatGui = (function(window){
	...
	//	this.gui.addColor(APP.Views.Index, 'particleColor');
		...
		var distanceMax = this.gui.add(APP.Views.Index, 'distanceMax', 30, 150).step(1);
		var attraction = this.gui.add(APP.Views.Index, 'attraction', 1, 100).step(1);
		
		particleColor.onChange(APP.Views.Index.changeParticleColor.bind(APP.Views.Index));
		particleRadius.onChange(APP.Views.Index.changeParticleRadius.bind(APP.Views.Index));
		distanceMax.onChange(APP.Views.Index.changeParticleDistMax.bind(APP.Views.Index));
		attraction.onChange(APP.Views.Index.changeParticleAttraction.bind(APP.Views.Index));
